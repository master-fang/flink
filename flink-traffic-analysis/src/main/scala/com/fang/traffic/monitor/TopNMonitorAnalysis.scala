...
object TopNMonitorAnalysis {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val stream: DataStream[TrafficInfo] = streamEnv.addSource(
      new FlinkKafkaConsumer[String](KafkaConstants.CAT_TRAFFIC_INFO_TOPIC, new SimpleStringSchema(), KafkaPropertiesUtil.getKafkaProperties(KafkaConstants.TOP_N_MONITOR))
